...
CREATE TABLE FILE (
  ...
  FILE_TYPE ENUM ('Image', 'PDF', 'Word', 'Excel', 'PowerPoint', 'Compressed Archive', 'Text', 'File', 'Audio', 'Video', 'Executable'),
...
CREATE TABLE COMMENT {
  ...
  FOREIGN KEY FILE_ID REFERENCSE FILE(ID),
  FOREIGN KEY USER_ID REFERENCSE USER(ID),
