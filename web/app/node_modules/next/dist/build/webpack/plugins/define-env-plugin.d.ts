...
export interface DefineEnvPluginOptions {
    ...
    clientRouterFilters?: {
        staticFilter: ReturnType<import('next/dist/shared/lib/bloom-filter').BloomFilter['export']>;
        dynamicFilter: ReturnType<import('next/dist/shared/lib/bloom-filter').BloomFilter['export']>;
    };
